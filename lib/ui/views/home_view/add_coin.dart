                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        TypeAheadField<CryptoCoin>(
                          ...
                          suggestionsCallback: (pattern) => model.allcoins
                              .where((s) =>
                                  s.Name.toString()
                                      .toLowerCase()
                                      .contains(pattern) ||
                          ...
                          itemBuilder: (BuildContext context, itemData) =>
                              ListTile(
                                title: Text(
                                    "${itemData.Name} (${itemData.Symbol.toUpperCase()})"),
                              ),
                        ...
                        MaterialButton(
                          ...
                          child: (model.state!=ViewState.Busy)?Text(
                            "Add Coin",
                            style: TextStyle(color: Colors.white),
                          ...
                          onPressed: (selectedCoin != null)
                              ? () async {
                                  if (selectedCoin != null) {
                                    await model.addCoin(selectedCoin);
